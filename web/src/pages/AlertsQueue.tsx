...
function AlertCard({
  ...
  const StatusIcon =
    statusIcons[alert.status as keyof typeof statusIcons] || AlertTriangle;
  return (
    <div
    ...
    >
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          >
            {alert.priority?.toLowerCase() || "unknown"}
          </span>
        </div>
...
export default function AlertsQueue() {
  ...
  const selectedAlertData = alerts.find(
    (alert: any) => alert.id === selectedAlert,
  );
  ...
  const shouldVirtualize = filteredAlerts.length > 2000;
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-2 text-gray-600">
          Monitor and triage critical system alerts in real-time
        </p>
      </div>
      {}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow border border-gray-200 p-6 text-center">
          ...
          <div className="text-3xl font-bold text-gray-900 mb-1">
            {alerts.filter((a: any) => a.priority === "CRITICAL").length}
          </div>
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200 p-6 text-center">
          ...
          <div className="text-3xl font-bold text-gray-900 mb-1">
            {alerts.filter((a: any) => a.priority === "HIGH").length}
          </div>
        ...
        <div className="bg-white rounded-lg shadow border border-gray-200 p-6 text-center">
          ...
          <div className="text-3xl font-bold text-gray-900 mb-1">
            {alerts.filter((a: any) => a.assigned_agent).length}
          </div>
        ...
        {isLoading ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-white rounded-lg shadow border border-gray-200 animate-pulse"
              >
          ...
          <div
            ref={parentRef}
            className="h-[900px] overflow-auto"
            aria-label="Virtualized alerts list"
          >
            <div
              style={{
