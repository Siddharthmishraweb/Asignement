...
describe("Middleware Tests", () => {
  ...
  describe("rateLimitMiddleware", () => {
    ...
    it("should fail open when Redis is unavailable", async () => {
      (mockRedis.checkTokenBucket as jest.Mock).mockRejectedValue(
  ...
  describe("idempotencyMiddleware", () => {
    ...
    it("should return cached result for duplicate requests", async () => {
      ...
      (mockRedis.getIdempotencyResult as jest.Mock).mockResolvedValue(
        cachedResult,
      );
      const middleware = idempotencyMiddleware(mockRedis);
      await middleware(mockReq as Request, mockRes as Response, mockNext);
    ...
    it("should handle Redis errors gracefully", async () => {
      ...
      (mockRedis.getIdempotencyResult as jest.Mock).mockRejectedValue(
