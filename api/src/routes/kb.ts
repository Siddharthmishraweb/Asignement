...
export const createKnowledgeBaseRouter = (config: RouteConfig): Router => {
  ...
  router.get(
    ...
    asyncErrorHandler(async (req: Request, res: Response) => {
      ...
      `;
        ...
        metrics.incrementCounter("kb_search_total", {
  ...
  router.get(
    ...
    asyncErrorHandler(async (req: Request, res: Response) => {
      ...
      try {
        ...
        metrics.incrementCounter("kb_article_view_total", {
  ...
  router.post(
    ...
    asyncErrorHandler(async (req: Request, res: Response) => {
      ...
      logger.info("Creating knowledge article", {
        requestId,
      ...
      try {
        ...
        metrics.incrementCounter("kb_article_created_total", {
  ...
  router.put(
    ...
    asyncErrorHandler(async (req: Request, res: Response) => {
      ...
      try {
        ...
        metrics.incrementCounter("kb_article_updated_total", {
  ...
  router.delete(
    ...
    asyncErrorHandler(async (req: Request, res: Response) => {
      ...
      logger.info("Deleting knowledge article", {
        requestId,
        articleId: id,
        permanent,
      });
